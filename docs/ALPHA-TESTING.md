...
Use this checklist for **v0.1.0-alpha.52** and later candidates built from immutable alpha.51. Automated CI is required, but physical X9 behavior, real Windows audio behavior and real battery charging behavior remain separate evidence classes and must not be inferred from hosted runners.
