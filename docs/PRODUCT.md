...
Current immutable prerelease: `v0.1.0-alpha.48`. Alpha.49 is a narrow Battery Preservation/release-verification follow-up; alpha.44 remains the hardware-behavior baseline.
