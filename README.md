...
ThinkControl has two connected surfaces: a compact notification-area flyout for everyday controls and a resizable Advanced window for detailed tuning and telemetry. The screenshots below are generated by the same WPF renderer used in CI and are committed with the release, so the README never depends on mutable release assets.
...
<p align="center">
  <img src="docs/screenshots/advanced-touchpad.png" alt="ThinkControl Touchpad" width="49%">
  <img src="docs/screenshots/advanced-sensors.png" alt="ThinkControl Sensors" width="49%">
</p>
